...
export default function LoginModal({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (isSignUp) {
      // Call your DB sign-up logic here
      console.log("Sign Up data submitted");
    } else {
      // Call your DB login logic here
      ...
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-8">
          <form onSubmit={handleSubmit} className="w-full flex flex-col items-center justify-center">
            ...
            <button type="submit" className="w-full h-11 rounded-full text-white primary hover:opacity-90 transition-opacity mb-4 cursor-pointer flex items-center justify-center font-medium active:scale-95">
